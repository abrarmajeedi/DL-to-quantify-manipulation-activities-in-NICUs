...
@register_dataset("chil_diap_change")
class CHIL_Diap_Change_Dataset(Dataset):
    def __init__(
        self,
        ...
        label_dict=None, # label dictionary if any
    ):
        # file path
    ...
    def __getitem__(self, idx):
        ...
        if video_item['segments'] is not None:
            ...
            if self.is_training:
                print("no annotations for training")
